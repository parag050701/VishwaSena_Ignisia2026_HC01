...
def calc_sofa(pt: PatientData) -> Dict:
    ...
    return dict(resp=resp, coag=coag, liver=liver, cardio=cardio, cns=cns, renal=renal, total=total, mortality_pct=mortality)
...
def calc_news2(pt: PatientData) -> Dict:
    ...
    return dict(total=total, level=level, breakdown=dict(RR=rr_s, SpO2=spo2_s, O2=o2_s, SBP=bp_s, HR=hr_s, GCS=cns_s, Temp=tmp_s))
